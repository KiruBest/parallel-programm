package lab2.TaskC;//import require classes and packages
...
public class PlotExample extends JPanel {
    ...
    PlotExample(ArrayList<Double> cordX, ArrayList<Double> cordY, ArrayList<Color> colors) {
        this.cordX = cordX;
        this.cordY = cordY;
        this.colors = colors;
    }
    ...
    public void draw(ArrayList<Double> cordX, ArrayList<Double> cordY, ArrayList<Color> colors) {
        ...
        frame.add(new PlotExample(cordX, cordY, colors));
